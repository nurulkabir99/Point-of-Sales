...
namespace PointInvt
{
    public partial class cashPurchase2 : Form
    {
        public cashPurchase2(string searchInvc)
        {
            InitializeComponent();
            ...
            try
            {
                ...
                while (read.Read())
                {
                    ...
                    BranchInfo.date = (read["VoucharDate"].ToString());
                    
                    //datePucharse.CustomFormat = "dd-MM-yyyy";
                    //datePucharse.Format = DateTimePickerFormat.Custom;
       ...
       public  static string max;
        ...
        {
            BranchInfo.SalesmanId = salesmanIDtxt.Text;
        ...
        private void cashPurchase2_Load(object sender, EventArgs e)
        {
            datePucharse.Text = BranchInfo.date;
        }
