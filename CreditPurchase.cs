...
namespace PointInvt
{
    public partial class CreditPurchase : Form
    {
        ...
        private void dataGridView1_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                //SqlConnection con = new SqlConnection(conString);
                //con.Open();
                //SqlCommand cmd = new SqlCommand("SELECT * from Inventory WHERE SerialNo = '" + SearchValue+ "'and InOut='0'", con);
                //cmd.ExecuteNonQuery();
                //SqlDataReader read = cmd.ExecuteReader();
        ...
        private void SearchBtn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.CommandText =
                    "select ItemCode as BarCode, ItemCode, ItemName, Quantity as QTY,UnitPrice as Price,TotalPrice as Total,SerialNo, CostUnit from Inventory where VoucharNo='" +
                    searchInvc + "'";
       ...
       public  static string max;
        ...
        {
            suplyerNameTxt.Text = suplyerNameTxt.Text.Split('-').Skip(0).FirstOrDefault();
               ...
               // dt.Clear();
                ...
                try
                {
                    ...
                    for (int r = 0; r < ProductList.RowCount - 1; r++)
                    {
                        ...
                        SqlCommand com =
                            new SqlCommand(
                                "insert into SuplyerInfo (SuplyerId,SuplyerName,ProductName,SerialNo,BuyDate,BuyAmount,CreditInvoice,VoucharNo,Branch) values ('" +
                                SuplyerIdTxt.Text + "','" + suplyerNameTxt.Text + "','" + g1.Cells[3].Value + "','" + g1.Cells[7].Value + "','" + datePucharse.Value.Date.ToString("yyyy-MM-dd") + "','" +
                                g1.Cells[6].Value + "','" + CreditInvcNoTxt.Text + "','" + invoiceNoText.Text + "','" + (comboBox2.SelectedIndex + 1) +
                                "')", con);
                        con.Open();
                        com.ExecuteNonQuery();
                        con.Close();
        ...
        private void editText_Click(object sender, EventArgs e)
        {
            ...
            if (confirmResult == DialogResult.Yes)
            {
                try
                {
                    ...
                    SqlCommand com1 =
                        new SqlCommand(
                            "Update HeadInventory set GrossTotal='" + grossTotal.Text + "',Discount='" +discountText.Text + "'," +
                    ...
                    for (int r = 0; r < ProductList.RowCount - 1; r++)
                    {
                        ...
                        SqlCommand com =
                            new SqlCommand(
                                ...
                                g1.Cells[6].Value + "', SerialNo='" + g1.Cells[7].Value + "' where VoucharNo='" + invoiceNoText.Text + "' and serialNo='"+g1.Cells[7].Value+"'", con);
                        SqlCommand com2 =
                            new SqlCommand(
        ...
        private void suplyerNameTxt_SelectedIndexChanged(object sender, EventArgs e)
        {
            //suplyerNameTxt.Text = suplyerNameTxt.Text.Split('-').Skip(0).FirstOrDefault();
            SuplyerIdTxt.Text = suplyerNameTxt.Text.Split('-').Skip(1).FirstOrDefault();
        }
    }
}
