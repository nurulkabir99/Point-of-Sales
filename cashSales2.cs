...
namespace PointInvt
{
    public partial class cashSales2 : Form
    {
        public cashSales2()
        {
            InitializeComponent();
        ...
        private void dataGridView1_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                SqlConnection con = new SqlConnection(conString);
                con.Open();
                SqlCommand cmd = new SqlCommand("SELECT * from Inventory WHERE SerialNo = '" + SearchValue + "' and Branch='"+(comboBox2.SelectedIndex+1)+"'", con);
                ...
                cons.Close(); try
                {
                    ...
                    SqlCommand com1 =
                        new SqlCommand(
                            ...
                            max + "','SI','" + datePucharse.Value.Date.ToString("yyyy-MM-dd") + "','" + SuplyerIdTxt.Text +
                    ...
                    for (int r = 0; r < ProductList.RowCount - 1; r++)
                    {
                        ...
                        SqlCommand com =
                            new SqlCommand(
                                ...
                                "','1','" + datePucharse.Value.Date.ToString("yyyy-MM-dd") + "')", con);
                        con.Open();
                        com.ExecuteNonQuery();
                        con.Close();
                    }
        ...
        private void editText_Click(object sender, EventArgs e)
        {
            ...
            //{
                try
                {
                    ...
                    {
                        EditcashSales ecSales = new EditcashSales(invoiceNoText.Text);
                        this.Close();
                        ecSales.Show();
                    }
                    else
