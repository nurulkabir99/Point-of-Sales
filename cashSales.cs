...
namespace PointInvt
{
    public partial class cashSales : Form
    {
        ...
        private void editText_Click(object sender, EventArgs e)
        {
            ...
            //        SqlCommand com1 =
            //            new SqlCommand(
            //                "Update HeadInventory set VoucharDate='" + datePucharse.Value.Date + "', GrossTotal='" + grossTotal.Text + "',Discount='" + discountText.Text + "',SalesmanId='" + salesmanIDtxt.Text + "'," +
            ...
            //                    g1.Cells[6].Value + "', SerialNo='" + g1.Cells[7].Value + "', Date='" + datePucharse.Value.Date + "' where VoucharNo='" + invoiceNoText.Text + "'and serialNo='" + g1.Cells[7].Value + "'and Id='" + g1.Cells[9].Value + "'", con);
            //            con.Open();
            //            com.ExecuteNonQuery();
            //            con.Close();
            //        }
